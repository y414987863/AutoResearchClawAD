...
# Classification discovery/reading/filtering live in one shared module
# (researchclaw.pipeline.llm4ad_utils.classification), imported by both this
# stage-13 package builder and stage 10's classifier. They must agree on the
# file's shape exactly: stage 10 decides each algorithm's role, this module
# selects on it, and a format drift between the two shows up as a scope that
# matches nothing and silently evolves nothing.
from researchclaw.pipeline.llm4ad_utils.classification import (
    discover_algorithms as _discover_algorithms,
